...
/**
 * TagPostSearch represents the model behind the search form of `app\models\Post` filtered by a specific tag.
 */
class TagPostSearch extends Model
{
    /**
     * @var int|null The ID of the tag to filter posts by.
     */
    ...
    public function search($params): ActiveDataProvider
    {
        ...
        $query->leftJoin('post_tag', 'post.id = post_tag.post_id')
            ->andWhere(['post_tag.tag_id' => $this->tagId]);
