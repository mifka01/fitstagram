...
<div class="site-signup">
    ...
    <p class="mt-2">Please fill out the following fields to signup:</p>
    ...
    <div class="flex justify-center mt-6">
        <div class="w-full max-w-md">
            <?php $form = ActiveForm::begin(['id' => 'form-signup']); ?>
                ...
                <div class="mt-6">
                    <?= Html::submitButton('Signup', ['class' => 'w-full py-2 px-4 border border-transparent rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500', 'name' => 'signup-button']) ?>
                </div>
